...
# Page settings
layout: default
keywords: OpenHarmony, embodied intelligence, ATC 2026, tutorial
comments: false
title: ATC 2026 Tutorial
description: "Exploring Embodied Intelligence with OpenHarmony: A Practical Tutorial"
micro_nav: true
permalink: /tutorial-atc2026/
---
...
<div class="callout callout--warning">
  <p><strong>Participants:</strong> Around 50 participants are expected. Prior knowledge of operating systems and basic programming concepts is beneficial.</p>
</div>
...
<div class="media-left media-left--tutorial">
  <div class="media-left__content">
    ...
    <p>Associate Professor and Assistant Dean at Shanghai Sanda University, March 8th Red Banner Pacesetter, Huawei Developer Expert (HDE), and HarmonyOS Pioneer. She specializes in HarmonyOS development, OpenHarmony software-hardware collaboration, and medical data mining. She leads multiple provincial and ministerial projects, has published textbooks, and guides students to win national Class A competition awards. Email: <a href="mailto:zhuxinrong@sandau.edu.cn">zhuxinrong@sandau.edu.cn</a>.</p>
  </div>
</div>
...
<div class="media-left media-left--tutorial">
  <div class="media-left__content">
    ...
    <p><em>Invited speaker.</em> Assistant Professor at the John Hopcroft Center for Computer Science, School of Computer Science, Shanghai Jiao Tong University.</p>
  </div>
</div>
...
| **15:50 - 16:35** | Lecture 2 & Exercise 2: OpenHarmony Foundations for Embodied Intelligence -- Sim-to-Real Simulation System Design and Verification | OpenHarmony Embodied AI PMC Member |
| **16:35 - 17:20** | Lecture 3 & Exercise 3: OH-EDU and MuJoCo Integration -- Hardware-Software Co-Control, Joint Debugging, and Remote Control of Physical Devices | OpenHarmony Embodied AI PMC Member |
